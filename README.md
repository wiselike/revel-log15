...
# log15 [![godoc reference](https://godoc.org/github.com/wiselike/revel-log15?status.png)](https://godoc.org/github.com/wiselike/revel-log15) [![Build Status](https://travis-ci.org/inconshreveable/log15.svg?branch=master)](https://travis-ci.org/inconshreveable/log15)
...
```go
import log "github.com/wiselike/revel-log15"
```
